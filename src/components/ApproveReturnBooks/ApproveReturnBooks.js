...
const approveReturnBooks = (props) => {
    return (
        <div>
            <div className={classes.ActionButtons}>
                <Button
                    ...
                    style={{'marginRight': '2%'}}
                    bsStyle="primary"
                    onClick={() => props.approveReturnBook()}>Approve</Button>
                <Button
                    disabled={props.selectedBookId == ''}
                    bsStyle="danger"
                    onClick={() => props.rejectReturnBook()} >Reject</Button>
            </div>
...
export default approveReturnBooks;